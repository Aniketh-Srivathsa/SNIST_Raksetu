...
import { shouldShowEmailVerification } from '../../utils/authStatus';

export default function EmailVerificationBanner({ userProfile }) {
  ...
  // Reset dismissal when a different user opens the profile.
  useEffect(() => {
  ...
  // Don't show if user is verified, phone-registered, or banner is dismissed
  if (!shouldShowEmailVerification(user, userProfile) || isDismissed) {
    return null;
  }
