...
import { canUseVerifiedFeatures } from '../../utils/authStatus';

const bloodTypes = ['A+', 'A-', 'B+', 'B-', 'AB+', 'AB-', 'O+', 'O-'];

export default function EmergencyRequestModal({ show, setShow, setShowSuccess, userLocation, userProfile }) {
  ...
  const handleEmergencyRequest = async (e) => {
    ...
    if (currentUser && !canUseVerifiedFeatures(currentUser, userProfile)) {
