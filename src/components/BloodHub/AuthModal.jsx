...
import { getFirebaseAuthErrorMessage, getPhoneRegistrationEmail } from '../../utils/authStatus';
    ...
    try {
      if (authMode === 'login') {
        ...
        const loginEmail = loginIdentifier.includes('@')
          ? loginIdentifier
          : getPhoneRegistrationEmail(loginIdentifier);
        ...
        const generatedEmail = getPhoneRegistrationEmail(formData.phone);
                ...
                {authMode === 'login' && (
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="w-full px-4 py-3 sm:py-2.5 text-base sm:text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all"
                      placeholder="Enter your email or registered phone"
                      required
                    />
                  </div>
                )}
